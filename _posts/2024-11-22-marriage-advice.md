...
image: /assets/img/posts/the-two-line-code-for-marital-bliss-that-your-programmer-husband-can-understand.png
...
<svg width="800" height="300" viewBox="0 0 800 300" xmlns="http://www.w3.org/2000/svg" font-family="'Courier New', monospace">
  <defs>
    <linearGradient id="editor-bg" x1="0%" y1="0%" x2="0%" y2="100%">
  ...
  <!-- Editor Window -->
  <rect class="editor-bg" x="50" y="20" width="700" height="260" rx="10" />

  <!-- Title Bar -->
  <circle cx="70" cy="40" r="6" fill="#E74C3C" />
  <circle cx="90" cy="40" r="6" fill="#F39C12" />
  <circle cx="110" cy="40" r="6" fill="#2ECC71" />
  <text class="title-text" x="400" y="45" text-anchor="middle">marriage_bliss.py</text>

  <!-- Line 1 -->
  <text class="line-number" x="90" y="100">1</text>
  <text class="code-keyword" x="110" y="100">if</text>
  <text class="code-punctuation" x="140" y="100">(</text>
  <text class="code-variable" x="150" y="100">wife_unhappy</text>
  <text class="code-operator" x="270" y="100">==</text>
  <text class="code-value" x="305" y="100">True</text>
  <text class="code-punctuation" x="355" y="100">):</text>

  <!-- Line 2 (indented) -->
  <text class="line-number" x="90" y="130">2</text>
  <text class="code-variable" x="140" y="130">life_unhappy</text>
  <text class="code-operator" x="260" y="130">=</text>
  <text class="code-value" x="285" y="130">True</text>
  <text class="code-punctuation" x="335" y="130">;</text>

  <!-- Line 3 (empty) -->
  <text class="line-number" x="90" y="160">3</text>

  <!-- Line 4 -->
  <text class="line-number" x="90" y="190">4</text>
  <text class="code-variable" x="110" y="190">spouse_significance</text>
  <text class="code-operator" x="295" y="190">&gt;</text>
  <text class="code-variable" x="320" y="190">your_significance</text>
  <text class="code-punctuation" x="490" y="190">;</text>

  <!-- Decorative Hearts -->
  <path class="heart" d="M 580 90 C 580 80, 570 70, 560 70 C 550 70, 545 75, 545 85 C 545 75, 540 70, 530 70 C 520 70, 510 80, 510 90 C 510 105, 545 120, 545 120 C 545 120, 580 105, 580 90 Z" />
  <path class="heart" d="M 650 170 C 650 160, 640 150, 630 150 C 620 150, 615 155, 615 165 C 615 155, 610 150, 600 150 C 590 150, 580 160, 580 170 C 580 185, 615 200, 615 200 C 615 200, 650 185, 650 170 Z" />

  <!-- Decorative Wedding Rings -->
  <circle class="ring" cx="680" cy="100" r="12" />
  <circle class="ring" cx="695" cy="100" r="12" />
  <circle class="ring" cx="720" cy="185" r="12" />
  <circle class="ring" cx="735" cy="185" r="12" />

  <!-- Comment at bottom -->
  <text x="110" y="245" fill="#95A5A6" font-size="13px" font-style="italic">// Two lines of code for a lifetime of happiness</text>
</svg>
