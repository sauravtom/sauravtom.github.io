...
If you're a PM who can't build, learn to build.
If you're an engineer who won't talk to customers, start talking to customers.
If you're a designer who thinks code is beneath you, that's fine, but the designer who *doesn't* think that just shipped your feature while you were picking fonts.
...
If you want to dive deeper into how product management is evolving, check out [this video by Claire Vo, CPO at LaunchDarkly](https://www.youtube.com/watch?v=example). She articulates this transformation way better than I do, and with significantly fewer made-up statistics.
